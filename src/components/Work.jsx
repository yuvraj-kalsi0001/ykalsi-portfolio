...
import todo_working from "../assets/todo_working.png";
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div>
                ...
                >
                  {(close) => (
                    <div className="modal flex items-center justify-center p-4 bg-white rounded-md">
                      ...
                      <div>
                        <p className="">
                          This Todos app ask for user registeration if your account does not exist, once logged in you can manage your todos tasks. This program is written in React using Node.Js for backend.
                        </p>
                      </div>
                    </div>
                  )}
                ...
                <a
                  href="https://github.com/yuvraj-kalsi0001/Todos"
                  target="_blank"
                >
                  <button
                    className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg"
